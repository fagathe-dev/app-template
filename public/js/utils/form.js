...
var _FormManager = class _FormManager {
  constructor({ form, initialData: initialData2 }) {
    __publicField(this, "form");
    __publicField(this, "initialData");
    this.form = form;
    this.initialData = initialData2;
    this.init();
  }
  getData() {
    ...
    for (const field of fields) {
      ...
      if (violations2.hasOwnProperty(name)) {
        ...
        if (error === null) {
          ...
          error.innerHTML = violations2[name];
...
var formManager = new FormManager({ form: document.getElementById("formManagerId"), initialData });
