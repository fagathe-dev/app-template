      ...
      if (e.checkValidity())
        if (
          ...
          tasksList.add({
            ...
            project_name:
              '<a href="apps-projects-overview.html" class="fw-medium link-primary">' + projectNameField.value + '</a>',
            tasks_name: tasksTitleField.value,
            client_name: clientNameField.value,
            assignedto: assignToUsers(),
            due_date: fomateDate(dateDueField.value),
        ...
        e.addEventListener('click', function (e) {
          ...
          Array.from(t).forEach(function (e) {
            ...
            if (t == itemId) {
              (editlist = !0),
                (idField.value = t),
                (project = new DOMParser().parseFromString(e._values.project_name, 'text/html'));
