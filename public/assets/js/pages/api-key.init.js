  ...
  Array.from(e).forEach(function (e) {
    apiKeyList.add({
      ...
      'Active' == e.status
        ...
        : 'Disable' == e.status && (document.querySelector('.disable-btn').innerHTML = 'Enable'),
      refreshCallbacks();
  }),
  ...
  Array.from(document.getElementsByName('chk_child')).forEach(function (e) {
    e.addEventListener('change', function (t) {
      ...
      t.target.closest('tr').classList.contains('table-active'),
        (document.getElementById('remove-actions').style.display = n > 0 ? 'block' : 'none');
    });
  });
}
...
document.getElementById('createApi-btn').addEventListener('click', function (e) {
  if (0 == apiKeyNameField.value.length) {
    ...
    return (
      ...
      setTimeout(() => document.getElementById('api-key-error-msg').classList.add('d-none'), 2e3),
  ...
  addBtn.addEventListener('click', function (e) {
    ...
    if (
      ...
      return (t.innerHTML = 'Please enter api key name'), !1;
    '' !== apiKeyNameField.value &&
      '' !== apiKeyField.value &&
      (apiKeyList.add({
