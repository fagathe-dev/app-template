  ...
  if (null !== document.getElementById(e)) {
    ...
    if (r)
      return (r = JSON.parse(r)).map(function (e) {
        ...
        var a = e.split(',');
        if (2 == a.length) {
          var o = getComputedStyle(document.documentElement).getPropertyValue(a[0]);
          return (o = 'rgba(' + o + ',' + a[1] + ')');
        }
        return r;
      });
...
if (dealTypeChartsColors) {
  var options = {
    ...
    chart: { height: 270, type: 'radar', dropShadow: { enabled: !0, blur: 1, left: 1, top: 1 }, toolbar: { show: !1 } },
    stroke: { width: 2 },
    fill: { opacity: 0.2 },
    legend: {
      show: !1,
...
if (barchartColors) {
  options = {
    series: [
      { name: 'Like', data: [12.45, 16.2, 8.9, 11.42, 12.6, 18.1, 18.2, 14.16] },
      { name: 'Share', data: [-11.45, -15.42, -7.9, -12.42, -12.6, -18.1, -18.2, -14.16] },
    ],
    ...
    xaxis: { categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug'], labels: { rotate: -90 } },
  };
...
function loadCharts() {
  ...
  e &&
    ...
    (worldemapmarkers = new jsVectorMap({
      ...
      markersSelectable: !0,
      markers: [
        { name: 'United States', coords: [37.0902, 95.7129], style: { image: '/assets/images/flags/us.svg' } },
        { name: 'Russia', coords: [61.524, 105.3188], style: { image: '/assets/images/flags/russia.svg' } },
        { name: 'Spain', coords: [40.4637, 3.7492], style: { image: '/assets/images/flags/spain.svg' } },
        { name: 'Italy', coords: [41.8719, 12.5674], style: { image: '/assets/images/flags/italy.svg' } },
        { name: 'Germany', coords: [51.1657, 10.4515], style: { image: '/assets/images/flags/germany.svg' } },
      ],
