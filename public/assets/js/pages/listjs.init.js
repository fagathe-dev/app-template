...
if (document.getElementById('customerList'))
  var customerList = new List('customerList', options).on('updated', function (e) {
...
function updateList() {
  ...
  (data = userList.filter(function (t) {
    var a = !1;
    return 'All' == e ? (a = !0) : ((a = t.values().sts == e), console.log(a, 'statusFilter')), a;
  })),
    userList.update();
}
refreshCallbacks(),
...
function deleteMultiple() {
  ...
  if (
    (Array.from(e).forEach(function (e) {
      if (1 == e.checked) {
        var t = e.parentNode.parentNode.parentNode.querySelector('.id a').innerHTML;
        ids_array.push(t);
      }
    }),
