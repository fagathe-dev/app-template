...
function formatDate(e) {
  var t = new Date(e),
    ...
    n = '' + t.getDate(),
    i = t.getFullYear();
  return a.length < 2 && (a = '0' + a), n.length < 2 && (n = '0' + n), [n + ' ' + a, i].join(', ');
}
        ...
        Array.from(t).forEach(function (e) {
          if (
            ...
            var t = `\n                        <div class="card-body text-center">\n                            <div class="position-relative d-inline-block">\n                                <img src="${
              new DOMParser().parseFromString(e._values.name, 'text/html').body.querySelector('img').src
            }" alt=""\n                                    class="avatar-lg rounded-circle img-thumbnail object-fit-cover">\n                                <span class="contact-active position-absolute rounded-circle bg-success"><span\n                                        class="visually-hidden"></span>\n                            </div>\n                            <h5 class="mt-4 mb-1">${
              new DOMParser().parseFromString(e._values.name, 'text/html').body.querySelector('.name').innerHTML
            }</h5>\n                            <p class="text-muted">${
