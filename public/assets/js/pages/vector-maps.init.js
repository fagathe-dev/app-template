  ...
  if (null !== document.getElementById(r)) {
    ...
    if (o)
      return (o = JSON.parse(o)).map(function (r) {
        ...
        var e = r.split(',');
        if (2 == e.length) {
          var t = getComputedStyle(document.documentElement).getPropertyValue(e[0]);
          return (t = 'rgba(' + t + ',' + e[1] + ')');
        }
        return o;
      });
...
if (vectorMapWorldMarkersColors)
  var worldemapmarkers = new jsVectorMap({
    ...
    selectedMarkers: [0, 2],
    regionStyle: {
      initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapWorldMarkersColors, fillOpacity: 1 },
    },
    markersSelectable: !0,
    markers: [
...
if (vectorMapWorldMarkersImageColors)
  var worldemapmarkersimage = new jsVectorMap({
    ...
    zoomButtons: !1,
    regionStyle: {
      initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapWorldMarkersImageColors, fillOpacity: 1 },
    },
    selectedMarkers: [0, 2],
    markersSelectable: !0,
    markers: [
...
if (vectorMapUsaColors)
  var usmap = new jsVectorMap({
    ...
    regionStyle: { initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapUsaColors, fillOpacity: 1 } },
    zoomOnScroll: !1,
    zoomButtons: !1,
  });
...
if (vectorMapCanadaColors)
  var canadamap = new jsVectorMap({
    ...
    regionStyle: { initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapCanadaColors, fillOpacity: 1 } },
    zoomOnScroll: !1,
    zoomButtons: !1,
  });
...
if (vectorMapRussiaColors)
  var russiamap = new jsVectorMap({
    ...
    regionStyle: { initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapRussiaColors, fillOpacity: 1 } },
    zoomOnScroll: !1,
    zoomButtons: !1,
  });
...
if (vectorMapSpainColors)
  var spainmap = new jsVectorMap({
    ...
    regionStyle: { initial: { stroke: '#9599ad', strokeWidth: 0.25, fill: vectorMapSpainColors, fillOpacity: 1 } },
    zoomOnScroll: !1,
    zoomButtons: !1,
  });
