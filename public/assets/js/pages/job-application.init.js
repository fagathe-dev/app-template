...
function filterData() {
  ...
  applicationList.filter(function (l) {
    ...
    return (
      ...
      (d =
        new Date(l.values().date.slice(0, 12)) >= new Date(n) && new Date(l.values().date.slice(0, 12)) <= new Date(i)),
      o && c && d ? o && c && d : o && c && '' == a ? o && c : c && d && '' == a ? c && d : void 0
    );
  }),
    applicationList.update();
}
        ...
        Array.from(t).forEach(function (e) {
          ...
          if (t == itemId) {
            ...
            example.setChoiceByValue(i),
              flatpickr('#date-field', { enableTime: !1, dateFormat: 'd M, Y', defaultDate: e._values.date });
          }
        });
      });
    });
