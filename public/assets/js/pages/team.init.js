    ...
    t.addEventListener('click', function (r) {
      (e = t.getAttribute('data-remove-id')),
        document.getElementById('remove-item').addEventListener('click', function () {
          ...
          loadTeamData((allmemberlist = r)), document.getElementById('close-removeMemberModal').click();
        });
    });
  });
}
  ...
  Array.from(document.querySelectorAll('.team-box')).forEach(function (e) {
    e.querySelector('.member-name').addEventListener('click', function () {
      ...
      (document.querySelector('#member-overview .profile-img').src = t),
        ...
        (document.querySelector('#member-overview .profile-name').innerHTML = r),
        (document.querySelector('#member-overview .profile-designation').innerHTML = m),
        (document.querySelector('#member-overview .profile-project').innerHTML = n),
        (document.querySelector('#member-overview .profile-task').innerHTML = a);
    });
  });
}
      ...
      e.addEventListener(
        ...
        function (t) {
          if (e.checkValidity()) {
            ...
            r = '/assets/images/users/user-dummy-img.jpg' == n.substring(n.indexOf('/as') + 1) ? '' : n;
            var l = m
              .match(/\b(\w)/g)
              .join('')
              .substring(0, 2);
            ...
            loadTeamData(allmemberlist), document.getElementById('createMemberBtn-close').click();
