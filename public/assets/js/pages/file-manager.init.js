function getChartColorsArray(e) {
  if (null !== document.getElementById(e)) {
    ...
    return (t = JSON.parse(t)).map(function (e) {
      ...
      var i = e.split(',');
      if (2 == i.length) {
        var n = getComputedStyle(document.documentElement).getPropertyValue(i[0]);
        return (n = 'rgba(' + n + ',' + i[1] + ')');
      }
      return t;
    });
...
getJSON('filemanager-filelist.json', function (e, t) {
  ...
  favouriteBtn(),
  Array.from(document.querySelectorAll('.file-manager-menu a')).forEach(function (e) {
    e.addEventListener('click', function () {
      ...
      'Recents' == l && (document.getElementById('folder-list').style.display = 'none'), loadFileData(i);
    });
  });
  ...
  Array.from(document.querySelectorAll('.folder-card')).forEach(function (e) {
    Array.from(e.querySelectorAll('.edit-folder-list')).forEach(function (t) {
      t.addEventListener('click', function (t) {
        ...
        l == e.querySelector('.form-check .form-check-input').getAttribute('id').split('_')[1] &&
          ((editFlag = !0),
          ...
          (document.getElementById('foldername-input').value = e.querySelector('.folder-name').innerHTML));
      });
    });
  });
}
        ...
        if (
          ...
          if ('' !== l && editFlag) {
            ...
            (n = document.getElementById('folderid-input').value),
              (document.getElementById(n).querySelector('.folder-name').innerHTML = l),
          ...
          document.getElementById('folderlist-data').insertAdjacentHTML('afterbegin', folderlisthtml),
            document.getElementById('addFolderBtn-close').click(),
            editFolderList();
        (document.getElementById('folderid-input').value = ''),
          (document.getElementById('foldername-input').value = '');
...
removeProduct &&
  removeProduct.addEventListener('show.bs.modal', function (e) {
    document.getElementById('remove-folderList').addEventListener('click', function (t) {
      e.relatedTarget.closest('.folder-card').remove(), document.getElementById('close-removeFoldermodal').click();
    });
  });
...
function fileDetailShow() {
  ...
  Array.from(document.querySelectorAll('.close-btn-overview')).forEach(function (t) {
    t.addEventListener('click', function () {
      e.classList.remove('file-detail-show');
    });
  }),
    Array.from(document.querySelectorAll('#file-list tr')).forEach(function (t) {
      t.querySelector('.viewfile-list').addEventListener('click', function () {
        ...
        (document.querySelector('#file-overview .file-icon i').className = i),
          ...
          (document.querySelector('#file-overview .file-type').innerHTML = d),
          document.querySelector('#file-overview .remove-file-overview').setAttribute('data-remove-id', l),
  ...
  Array.from(document.querySelectorAll('.file-menu-btn')).forEach(function (e) {
    ...
    window.addEventListener('click', function (e) {
      document.querySelector('.file-manager-sidebar').classList.contains('menubar-show') &&
        (t || document.querySelector('.file-manager-sidebar').classList.remove('menubar-show'), (t = !1));
    });
}
    ...
    function (t) {
      if (e.checkValidity()) {
        ...
        if ('' === l || editFlag) {
          ...
          allFileList.push(o), sortElementsById(), document.getElementById('addFileBtn-close').click();
        }
