...
Array.from(document.querySelectorAll('.filter-accordion .accordion-item')).forEach(function (e) {
  var t = e.querySelectorAll('.filter-check .form-check .form-check-input:checked').length;
  (e.querySelector('.filter-badge').innerHTML = t),
    Array.from(e.querySelectorAll('.form-check .form-check-input')).forEach(function (i) {
      var r = i.value;
      i.checked && filterChoicesInput.setValue([r]),
        i.addEventListener('click', function (s) {
          i.checked
            ? (t++,
              (e.querySelector('.filter-badge').innerHTML = t),
              (e.querySelector('.filter-badge').style.display = t > 0 ? 'block' : 'none'),
...
searchBrandsOptions.addEventListener('keyup', function () {
  ...
  Array.from(t).forEach(function (t) {
    var i = t.getElementsByClassName('form-check-label')[0].innerText.toLowerCase();
      ...
      Array.from(document.querySelectorAll('.checkbox-product-list input')).forEach(function (e) {
        e.addEventListener('click', function (e) {
          ...
          (isSelected = t.length),
            ...
            (document.getElementById('selection-element').style.display = isSelected > 0 ? 'block' : 'none');
        });
      }),
        removeItems(),
        removeSingleItem();
      ...
      document.getElementById('delete-product').addEventListener('click', function () {
        Array.from(document.querySelectorAll('.gridjs-table tr')).forEach(function (e) {
          ...
          if (e.classList.contains('gridjs-tr-selected')) {
            ...
            (productListAllData = t), (productListPublishedData = s), e.remove();
          }
        }),
    ...
    t.addEventListener('click', function (i) {
      (e = t.getAttribute('data-id')),
        document.getElementById('delete-product').addEventListener('click', function () {
          ...
          (productListAllData = r), (productListPublishedData = s), t.closest('.gridjs-tr').remove();
        });
    });
  });
  var t = 0;
  Array.from(document.querySelectorAll('.edit-list')).forEach(function (e) {
    e.addEventListener('click', function (i) {
      (t = e.getAttribute('data-edit-id')),
        (productListAllData = productListAllData.map(function (e) {
          return e.id == t && sessionStorage.setItem('editInputValue', JSON.stringify(e)), e;
        }));
    });
  });
}
