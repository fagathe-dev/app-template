!(function () {
        ...
        e.addEventListener('show.bs.collapse', function (a) {
          ...
          if (n) {
            ...
            Array.from(s).forEach(function (e) {
              e.childNodes.length > 2 && e.firstElementChild.setAttribute('aria-expanded', 'false');
  ...
  function d() {
    ...
    if (n && ('twocolumn' == t || 'twocolumn' == n['data-layout'])) {
      document.querySelector('.navbar-menu') && (document.querySelector('.navbar-menu').innerHTML = e);
      var o = document.createElement('ul');
      (o.innerHTML = '<a href="#" class="logo"><img src="/assets/images/logo-sm.png" alt="" height="22"></a>'),
      ...
      var s = '/' == location.pathname ? 'index' : location.pathname.substring(1);
      if ((s = s.substring(s.lastIndexOf('/') + 1))) {
        var d = document.getElementById('navbar-nav').querySelector('[href="' + s + '"]');
        if (d) {
          ...
          i &&
            ...
            i.parentElement.closest('.collapse.menu-dropdown') &&
              ...
              i.parentElement.closest('.collapse').previousElementSibling &&
                i.parentElement.closest('.collapse').previousElementSibling.classList.add('active'),
              i.parentElement.parentElement.parentElement.parentElement.closest('.collapse.menu-dropdown') &&
                (i.parentElement.parentElement.parentElement.parentElement.closest('.collapse').classList.add('show'),
                i.parentElement.parentElement.parentElement.parentElement.closest('.collapse').previousElementSibling &&
      ...
      if (
        ...
        Array.from(document.querySelector('#two-column-menu ul').querySelectorAll('li a')).forEach(function (e) {
          var t = '/' == location.pathname ? 'index' : location.pathname.substring(1);
          (t = t.substring(t.lastIndexOf('/') + 1)),
            e.addEventListener('click', function (a) {
              if (
                ((t != '/' + e.getAttribute('href') || e.getAttribute('data-bs-toggle')) &&
                ...
                var o = (a.target.matches('i') ? a.target.closest('a') : a.target).getAttribute('href').slice(1);
                document.getElementById(o) &&
                  document.getElementById(o).parentElement.classList.add('twocolumn-item-show');
              }
            }),
        ...
        var r = new SimpleBar(document.getElementsByClassName('twocolumn-iconview')[0]);
  ...
  function l() {
    ('vertical' != document.documentElement.getAttribute('data-layout') &&
      ...
      'horizontal' == document.documentElement.getAttribute('data-layout') && y();
  }
  function r() {
    feather.replace();
    ...
    e < 1025 && e > 767
      ...
      : e <= 767 &&
        ...
        'twocolumn' == sessionStorage.getItem('data-layout') &&
          (document.documentElement.setAttribute('data-layout', 'vertical'), E('vertical'), s()),
        'horizontal' != sessionStorage.getItem('data-layout') &&
          document.documentElement.setAttribute('data-sidebar-size', 'lg'),
        document.querySelector('.hamburger-icon') && document.querySelector('.hamburger-icon').classList.add('open'));
    var t = document.querySelectorAll('#navbar-nav > li.nav-item');
    Array.from(t).forEach(function (e) {
      e.addEventListener('click', m.bind(this), !1), e.addEventListener('mouseover', m.bind(this), !1);
    });
  }
  function m(e) {
    if (e.target && e.target.matches('a.nav-link span'))
      if (0 == i(e.target.parentElement.nextElementSibling)) {
      ...
      } else if (1 == i(e.target.parentElement.nextElementSibling) && window.innerWidth >= 1848)
        for (var a = document.getElementsByClassName('dropdown-custom-right'); a.length > 0; )
          a[0].classList.remove('dropdown-custom-right');
    if (e.target && e.target.matches('a.nav-link'))
      if (0 == i(e.target.nextElementSibling)) {
      ...
      } else if (1 == i(e.target.nextElementSibling) && window.innerWidth >= 1848)
        for (a = document.getElementsByClassName('dropdown-custom-right'); a.length > 0; )
          a[0].classList.remove('dropdown-custom-right');
  }
  function c() {
    var e = document.documentElement.clientWidth;
    e > 767 && document.querySelector('.hamburger-icon').classList.toggle('open'),
      'horizontal' === document.documentElement.getAttribute('data-layout') &&
  ...
  function u() {
    document.addEventListener('DOMContentLoaded', function () {
      ...
      window.addEventListener('load', function () {
        var e;
        'twocolumn' == document.documentElement.getAttribute('data-layout') ? g() : b(),
      ...
      document.getElementById('topnav-hamburger-icon') &&
        document.getElementById('topnav-hamburger-icon').addEventListener('click', c);
  ...
  function g() {
    ...
    if ((e = e.substring(e.lastIndexOf('/') + 1))) {
      ...
      var t = document.getElementById('navbar-nav').querySelector('[href="' + e + '"]');
      if (t) {
        ...
        if (a && a.parentElement.closest('.collapse.menu-dropdown')) {
          if (
            ...
            a.parentElement.parentElement.parentElement.parentElement
              ...
              document.getElementById('two-column-menu').querySelector('[href="#' + n + '"]') &&
                document
                  .getElementById('two-column-menu')
                  .querySelector('[href="#' + n + '"]')
                  .classList.add('active');
          }
          var o = a.parentElement.closest('.collapse.menu-dropdown').getAttribute('id');
          document.getElementById('two-column-menu').querySelector('[href="#' + o + '"]') &&
            document
              .getElementById('two-column-menu')
              .querySelector('[href="#' + o + '"]')
              .classList.add('active');
        } else {
          t.closest('.collapse.menu-dropdown').parentElement.classList.add('twocolumn-item-show');
          o = a.getAttribute('id');
          document.getElementById('two-column-menu').querySelector('[href="#' + o + '"]') &&
            document
              .getElementById('two-column-menu')
        ...
        a &&
          ...
          a.parentElement.closest('.collapse.menu-dropdown') &&
            ...
            a.parentElement.closest('.collapse').previousElementSibling &&
              a.parentElement.closest('.collapse').previousElementSibling.classList.add('active'),
            a.parentElement.parentElement.parentElement.parentElement.closest('.collapse.menu-dropdown') &&
  ...
  function y() {
    (document.getElementById('two-column-menu').innerHTML = ''),
      ...
      document.getElementById('scrollbar').classList.remove('h-100');
    var t = document.querySelectorAll('ul.navbar-nav > li.nav-item'),
      a = '',
      n = '';
    Array.from(t).forEach(function (e, o) {
      o + 1 === 7 && (n = e),
        o + 1 > 7 && ((a += e.outerHTML), e.remove()),
        o + 1 === t.length &&
  ...
  function f(e) {
    if (e == e) {
      ...
      if ('hidden' === e['data-sidebar-visibility'])
        k('data-sidebar-visibility', 'hidden'),
      ...
      switch (e['data-bs-theme']) {
        case 'light':
          k('data-bs-theme', 'light'),
            document.documentElement.setAttribute('data-bs-theme', 'light'),
            sessionStorage.setItem('data-bs-theme', 'light');
          break;
        case 'dark':
          k('data-bs-theme', 'dark'),
      ...
      switch (e['data-layout-position']) {
        case 'fixed':
          k('data-layout-position', 'fixed'),
            sessionStorage.setItem('data-layout-position', 'fixed'),
            document.documentElement.setAttribute('data-layout-position', 'fixed');
          break;
        case 'scrollable':
          k('data-layout-position', 'scrollable'),
      ...
      switch (e['data-preloader']) {
        ...
        case 'enable':
          ...
          break;
        default:
          if (sessionStorage.getItem('data-preloader') && 'disable' == sessionStorage.getItem('data-preloader'))
            k('data-preloader', 'disable'),
              sessionStorage.setItem('data-preloader', 'disable'),
              document.documentElement.setAttribute('data-preloader', 'disable');
          ...
          } else document.documentElement.setAttribute('data-preloader', 'disable');
      }
      switch (e['data-body-image']) {
        case 'img-1':
          k('data-body-image', 'img-1'),
    ...
    setTimeout(function () {
      ...
      if (e) {
        var t = e.querySelector('.nav-item .active'),
          a = t ? t.offsetTop : 0;
        if (a > 300) {
          var n = document.getElementsByClassName('app-menu') ? document.getElementsByClassName('app-menu')[0] : '';
          n &&
            n.querySelector('.simplebar-content-wrapper') &&
            setTimeout(function () {
              n.querySelector('.simplebar-content-wrapper').scrollTop = 330 == a ? a + 85 : a;
            }, 0);
        }
      }
    }, 250);
    ...
    Array.from(document.querySelectorAll('input[name=' + e + ']')).forEach(function (a) {
      t == a.value ? (a.checked = !0) : (a.checked = !1),
        a.addEventListener('change', function () {
          ...
          } else 'data-preloader' == e && 'disable' == a.value && (document.documentElement.setAttribute('data-preloader', 'disable'), document.getElementById('customizerclose-btn').click());
          'data-bs-theme' == e && window.dispatchEvent(B);
        });
    }),
  ...
  function q() {
    if ('horizontal' !== document.documentElement.getAttribute('data-layout')) {
      ...
      if (document.getElementsByClassName('twocolumn-iconview')[0]) {
        var t = new SimpleBar(document.getElementsByClassName('twocolumn-iconview')[0]);
  ...
  !(function () {
    if (sessionStorage.getItem('defaultAttribute'))
      ((t = {})['data-layout'] = sessionStorage.getItem('data-layout')),
        ...
        (t['data-sidebar-image'] = sessionStorage.getItem('data-sidebar-image')),
        (t['data-layout-position'] = sessionStorage.getItem('data-layout-position')),
      ...
      Array.from(e).forEach(function (e) {
        ...
        f(t);
      var a = document.querySelector('.btn[data-bs-target="#theme-settings-offcanvas"]');
      a && a.click();
    }
  })(),
    d(),
    ...
    (S = document.getElementById('search-options')) &&
      (S.addEventListener('focus', function () {
        S.value.length > 0
          ? (I.classList.add('show'), h.classList.remove('d-none'))
          : (I.classList.remove('show'), h.classList.add('d-none'));
      }),
        ...
        if (S.value.length > 0) {
          ...
          Array.from(a).forEach(function (e) {
            ...
            if (e.querySelector('h6')) {
              ...
              a = o.includes(t) ? o : n;
            } else e.getElementsByTagName('span') && (a = e.getElementsByTagName('span')[0].innerText.toLowerCase());
            a && (e.style.display = a.includes(t) ? 'block' : 'none');
          });
        } else I.classList.remove('show'), h.classList.add('d-none');
      }),
      h.addEventListener('click', function () {
        (S.value = ''), I.classList.remove('show'), h.classList.add('d-none');
      }),
      document.body.addEventListener('click', function (e) {
        'search-options' !== e.target.getAttribute('id') && (I.classList.remove('show'), h.classList.add('d-none'));
      })),
    (function () {
      ...
      e &&
        ...
        e.addEventListener('click', function () {
          (a.value = ''), t.classList.remove('show'), e.classList.add('d-none');
        }),
        document.body.addEventListener('click', function (a) {
          'search-options' !== a.target.getAttribute('id') && (t.classList.remove('show'), e.classList.add('d-none'));
        }));
    })(),
    (function () {
    ...
    (A = document.querySelectorAll('.light-dark-mode')) &&
      ...
      A[0].addEventListener('click', function (e) {
        w.hasAttribute('data-bs-theme') && 'dark' == w.getAttribute('data-bs-theme')
          ? z('data-bs-theme', 'light', 'layout-mode-light', w)
          : z('data-bs-theme', 'dark', 'layout-mode-dark', w),
        ...
        Array.from(e).forEach(function (e) {
          !(function a() {
            var n = +e.getAttribute('data-target'),
              ...
              s = n / 250;
            s < 1 && (s = 1),
              o < n ? ((e.innerText = (o + s).toFixed(0)), setTimeout(a, 1)) : (e.innerText = t(n)),
              t(e.innerText);
          })();
        });
    })(),
        ...
        function t() {
          ...
          Array.from(document.getElementsByClassName('cart-item-price')).forEach(function (t) {
            ...
            document.getElementById('cart-item-total') &&
              (document.getElementById('cart-item-total').innerHTML = '$' + e.toFixed(2));
        }
        Array.from(document.querySelectorAll('#page-topbar .dropdown-menu-cart .remove-item-btn')).forEach(function (
          a
        ) {
          a.addEventListener('click', function (a) {
            e--,
              this.closest('.dropdown-item-cart').remove(),
              Array.from(document.getElementsByClassName('cartitem-badge')).forEach(function (t) {
                t.innerHTML = e;
              }),
              t(),
              document.getElementById('empty-cart') &&
                (document.getElementById('empty-cart').style.display = 0 == e ? 'block' : 'none'),
              document.getElementById('checkout-elem') &&
                (document.getElementById('checkout-elem').style.display = 0 == e ? 'none' : 'block');
          });
        }),
          Array.from(document.getElementsByClassName('cartitem-badge')).forEach(function (t) {
            t.innerHTML = e;
          ...
          Array.from(document.querySelectorAll('.notification-check input')).forEach(function (e) {
            e.addEventListener('change', function (e) {
              ...
              e.target.closest('.notification-item').classList.contains('active'),
                (document.getElementById('notification-actions').style.display = t > 0 ? 'block' : 'none'),
      ...
      Array.from(a).forEach(function (e) {
        if ('flatpickr' == e.getAttribute('data-provider')) {
          ...
          (a.disableMobile = 'true'),
            n['data-date-format'] && (a.dateFormat = n['data-date-format'].value.toString()),
            n['data-enable-time'] &&
              ((a.enableTime = !0), (a.dateFormat = n['data-date-format'].value.toString() + ' H:i')),
            n['data-altFormat'] && ((a.altInput = !0), (a.altFormat = n['data-altFormat'].value.toString())),
            n['data-minDate'] &&
            ...
            n['data-deafult-date'] &&
              ...
              (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-multiple-date'] && ((a.mode = 'multiple'), (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-range-date'] && ((a.mode = 'range'), (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-inline-date'] &&
              ((a.inline = !0),
              (a.defaultDate = n['data-deafult-date'].value.toString()),
              (a.dateFormat = n['data-date-format'].value.toString())),
            n['data-disable-date'] &&
              ((t = []).push(n['data-disable-date'].value), (a.disable = t.toString().split(','))),
            n['data-week-number'] && ((t = []).push(n['data-week-number'].value), (a.weekNumbers = !0)),
            flatpickr(e, a);
        } else if ('timepickr' == e.getAttribute('data-provider')) {
          var o = {},
            s = e.attributes;
          s['data-time-basic'] && ((o.enableTime = !0), (o.noCalendar = !0), (o.dateFormat = 'H:i')),
            s['data-time-hrs'] &&
              ((o.enableTime = !0), (o.noCalendar = !0), (o.dateFormat = 'H:i'), (o.time_24hr = !0)),
            s['data-min-time'] &&
              ((o.enableTime = !0),
              (o.noCalendar = !0),
              (o.dateFormat = 'H:i'),
    ...
    window.addEventListener('resize', function () {
      L && clearTimeout(L), (L = setTimeout(q, 2e3));
    });
})();
